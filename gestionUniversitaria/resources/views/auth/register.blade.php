...
<div class="md:flex ">
    ...
    <div class="md:w-4/12 bg-white rouded-lg p-5 shadow-xl">
        <form action="" method="post">
            ...
            <div class="mb-5">
                <label for="cedula" class="mb-2 block uppcase text-gray-500 font-bold">Apellido</label>
                <input type="text" name="apellido" id="apellido" placeholder="Apellido" class="border p-3  w-full rounded-lg">
                @error('cedula')
                    <p class="bg-red-500 text-white rounded-lg my-2 text5m text-center">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="mb-5">
                <label for="direccion" class="mb-2 block uppcase text-gray-500 font-bold"></label>
