    ...
    <div class="md:w-4/12 bg-white rouded-lg p-5 shadow-xl">
        <form action="" method="post">
            ...
            <div class="mb-5">
             ...
             {{-- boton --}}
           <input type="submit" value="Actualizar" class="bg-sky-600 hover:bg-sky-400 transition-color cursor-pointer uppercase font-bold w-full p-3  text-white  rounded-lg">
           </form>
